...
public class DeterministicMaxGoofSortGooflang extends BogoSorting {

    int min;

    public DeterministicMaxGoofSortGooflang(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);

        this.setSortListName("Deterministic Max Goof (Gooflang)");
