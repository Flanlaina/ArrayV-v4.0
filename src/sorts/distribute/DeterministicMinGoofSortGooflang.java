...
public class DeterministicMinGoofSortGooflang extends BogoSorting {

    int min;

    public DeterministicMinGoofSortGooflang(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);

        this.setSortListName("Deterministic Min Goof (Gooflang)");
