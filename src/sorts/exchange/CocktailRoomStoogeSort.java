...
public class CocktailRoomStoogeSort extends Sort {
    ...
    public CocktailRoomStoogeSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Cocktail Room Stooge");
        this.setRunAllSortsName("Cocktail Room Stooge Sort");
        this.setRunSortName("Cocktail Room Stoogesort");
