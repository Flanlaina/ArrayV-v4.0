...
final public class LogKitaSort extends Sort {
	public LogKitaSort(ArrayVisualizer arrayVisualizer) {
		super(arrayVisualizer);
		
		this.setSortListName("Log Kita");
		this.setRunAllSortsName("Log Kita Sort");
		this.setRunSortName("Log Kitasort");
