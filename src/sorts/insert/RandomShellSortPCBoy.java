...
*/
public class RandomShellSortPCBoy extends BogoSorting {
    public RandomShellSortPCBoy(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Randomized Shell (PCBoy)");
        this.setRunAllSortsName("PCBoy's Randomized Shell Sort");
        this.setRunSortName("PCBoy's Random Shellsort");
