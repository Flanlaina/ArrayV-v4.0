 ...
 *
 */
public class BufferlessCryoSort extends Sort {

    public BufferlessCryoSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Bufferless Cryo");
        this.setRunAllSortsName("Bufferless Cryo Sort");
        this.setRunSortName("Bufferless Cryosort");
    ...
    /**
     * Sorts the range {@code [a, b)} of {@code array} using Bufferless Cryo Sort.
     *
